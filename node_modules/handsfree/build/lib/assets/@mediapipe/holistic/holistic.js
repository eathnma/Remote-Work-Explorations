...
*/
'use strict';function u(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}}function v(a){var b="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];return b?b.call(a):{next:u(a)}}function y(a){if(!(a instanceof Array)){a=v(a);for(var b,c=[];!(b=a.next()).done;)c.push(b.value);a=c}return a}var z="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(a==Array.prototype||a==Object.prototype)return a;a[b]=c.value;return a};
function aa(a){a=["object"==typeof globalThis&&globalThis,a,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var b=0;b<a.length;++b){var c=a[b];if(c&&c.Math==Math)return c}throw Error("Cannot find global object");}var A=aa(this);function C(a,b){if(b)a:{var c=A;a=a.split(".");for(var d=0;d<a.length-1;d++){var f=a[d];if(!(f in c))break a;c=c[f]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&null!=b&&z(c,a,{configurable:!0,writable:!0,value:b})}}var D;
if("function"==typeof Object.setPrototypeOf)D=Object.setPrototypeOf;else{var E;a:{var ba={a:!0},I={};try{I.__proto__=ba;E=I.a;break a}catch(a){}E=!1}D=E?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var J=D;function K(){this.l=!1;this.h=null;this.j=void 0;this.g=1;this.s=this.m=0;this.i=null}function N(a){if(a.l)throw new TypeError("Generator is already running");a.l=!0}K.prototype.o=function(a){this.j=a};
function O(a,b){a.i={K:b,L:!0};a.g=a.m||a.s}K.prototype.return=function(a){this.i={return:a};this.g=this.s};function P(a,b,c){a.g=c;return{value:b}}function ca(a){this.g=new K;this.h=a}function da(a,b){N(a.g);var c=a.g.h;if(c)return Q(a,"return"in c?c["return"]:function(d){return{value:d,done:!0}},b,a.g.return);a.g.return(b);return R(a)}
function Q(a,b,c,d){try{var f=b.call(a.g.h,c);if(!(f instanceof Object))throw new TypeError("Iterator result "+f+" is not an object");if(!f.done)return a.g.l=!1,f;var k=f.value}catch(e){return a.g.h=null,O(a.g,e),R(a)}a.g.h=null;d.call(a.g,k);return R(a)}function R(a){for(;a.g.g;)try{var b=a.h(a.g);if(b)return a.g.l=!1,{value:b.value,done:!1}}catch(c){a.g.j=void 0,O(a.g,c)}a.g.l=!1;if(a.g.i){b=a.g.i;a.g.i=null;if(b.L)throw b.K;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
function ea(a){this.next=function(b){N(a.g);a.g.h?b=Q(a,a.g.h.next,b,a.g.o):(a.g.o(b),b=R(a));return b};this.throw=function(b){N(a.g);a.g.h?b=Q(a,a.g.h["throw"],b,a.g.o):(O(a.g,b),b=R(a));return b};this.return=function(b){return da(a,b)};this[Symbol.iterator]=function(){return this}}function S(a,b){b=new ea(new ca(b));J&&a.prototype&&J(b,a.prototype);return b}
C("Symbol",function(a){function b(f){if(this instanceof b)throw new TypeError("Symbol is not a constructor");return new c("jscomp_symbol_"+(f||"")+"_"+d++,f)}function c(f,k){this.g=f;z(this,"description",{configurable:!0,writable:!0,value:k})}if(a)return a;c.prototype.toString=function(){return this.g};var d=0;return b});
C("Symbol.iterator",function(a){if(a)return a;a=Symbol("Symbol.iterator");for(var b="Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "),c=0;c<b.length;c++){var d=A[b[c]];"function"===typeof d&&"function"!=typeof d.prototype[a]&&z(d.prototype,a,{configurable:!0,writable:!0,value:function(){return fa(u(this))}})}return a});function fa(a){a={next:a};a[Symbol.iterator]=function(){return this};return a}
var ha="function"==typeof Object.assign?Object.assign:function(a,b){for(var c=1;c<arguments.length;c++){var d=arguments[c];if(d)for(var f in d)Object.prototype.hasOwnProperty.call(d,f)&&(a[f]=d[f])}return a};C("Object.assign",function(a){return a||ha});
C("Promise",function(a){function b(e){this.h=0;this.i=void 0;this.g=[];this.o=!1;var g=this.j();try{e(g.resolve,g.reject)}catch(h){g.reject(h)}}function c(){this.g=null}function d(e){return e instanceof b?e:new b(function(g){g(e)})}if(a)return a;c.prototype.h=function(e){if(null==this.g){this.g=[];var g=this;this.i(function(){g.l()})}this.g.push(e)};var f=A.setTimeout;c.prototype.i=function(e){f(e,0)};c.prototype.l=function(){for(;this.g&&this.g.length;){var e=this.g;this.g=[];for(var g=0;g<e.length;++g){var h=
e[g];e[g]=null;try{h()}catch(l){this.j(l)}}}this.g=null};c.prototype.j=function(e){this.i(function(){throw e;})};b.prototype.j=function(){function e(l){return function(m){h||(h=!0,l.call(g,m))}}var g=this,h=!1;return{resolve:e(this.G),reject:e(this.l)}};b.prototype.G=function(e){if(e===this)this.l(new TypeError("A Promise cannot resolve to itself"));else if(e instanceof b)this.I(e);else{a:switch(typeof e){case "object":var g=null!=e;break a;case "function":g=!0;break a;default:g=!1}g?this.A(e):this.m(e)}};
b.prototype.A=function(e){var g=void 0;try{g=e.then}catch(h){this.l(h);return}"function"==typeof g?this.J(g,e):this.m(e)};b.prototype.l=function(e){this.s(2,e)};b.prototype.m=function(e){this.s(1,e)};b.prototype.s=function(e,g){if(0!=this.h)throw Error("Cannot settle("+e+", "+g+"): Promise already settled in state"+this.h);this.h=e;this.i=g;2===this.h&&this.H();this.D()};b.prototype.H=function(){var e=this;f(function(){if(e.F()){var g=A.console;"undefined"!==typeof g&&g.error(e.i)}},1)};b.prototype.F=
function(){if(this.o)return!1;var e=A.CustomEvent,g=A.Event,h=A.dispatchEvent;if("undefined"===typeof h)return!0;"function"===typeof e?e=new e("unhandledrejection",{cancelable:!0}):"function"===typeof g?e=new g("unhandledrejection",{cancelable:!0}):(e=A.document.createEvent("CustomEvent"),e.initCustomEvent("unhandledrejection",!1,!0,e));e.promise=this;e.reason=this.i;return h(e)};b.prototype.D=function(){if(null!=this.g){for(var e=0;e<this.g.length;++e)k.h(this.g[e]);this.g=null}};var k=new c;b.prototype.I=
function(e){var g=this.j();e.B(g.resolve,g.reject)};b.prototype.J=function(e,g){var h=this.j();try{e.call(g,h.resolve,h.reject)}catch(l){h.reject(l)}};b.prototype.then=function(e,g){function h(q,n){return"function"==typeof q?function(r){try{l(q(r))}catch(p){m(p)}}:n}var l,m,t=new b(function(q,n){l=q;m=n});this.B(h(e,l),h(g,m));return t};b.prototype.catch=function(e){return this.then(void 0,e)};b.prototype.B=function(e,g){function h(){switch(l.h){case 1:e(l.i);break;case 2:g(l.i);break;default:throw Error("Unexpected state: "+
l.h);}}var l=this;null==this.g?k.h(h):this.g.push(h);this.o=!0};b.resolve=d;b.reject=function(e){return new b(function(g,h){h(e)})};b.race=function(e){return new b(function(g,h){for(var l=v(e),m=l.next();!m.done;m=l.next())d(m.value).B(g,h)})};b.all=function(e){var g=v(e),h=g.next();return h.done?d([]):new b(function(l,m){function t(r){return function(p){q[r]=p;n--;0==n&&l(q)}}var q=[],n=0;do q.push(void 0),n++,d(h.value).B(t(q.length-1),m),h=g.next();while(!h.done)})};return b});
function ia(a,b){a instanceof String&&(a+="");var c=0,d=!1,f={next:function(){if(!d&&c<a.length){var k=c++;return{value:b(k,a[k]),done:!1}}d=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f}C("Array.prototype.keys",function(a){return a?a:function(){return ia(this,function(b){return b})}});var ja=this||self;
function T(a,b){a=a.split(".");var c=ja;a[0]in c||"undefined"==typeof c.execScript||c.execScript("var "+a[0]);for(var d;a.length&&(d=a.shift());)a.length||void 0===b?c[d]&&c[d]!==Object.prototype[d]?c=c[d]:c=c[d]={}:c[d]=b};function X(a,b){var c=void 0;return new (c||(c=Promise))(function(d,f){function k(h){try{g(b.next(h))}catch(l){f(l)}}function e(h){try{g(b["throw"](h))}catch(l){f(l)}}function g(h){h.done?d(h.value):(new c(function(l){l(h.value)})).then(k,e)}g((b=b.apply(a,void 0)).next())})};var ka=[[61,146],[146,91],[91,181],[181,84],[84,17],[17,314],[314,405],[405,321],[321,375],[375,291],[61,185],[185,40],[40,39],[39,37],[37,0],[0,267],[267,269],[269,270],[270,409],[409,291],[78,95],[95,88],[88,178],[178,87],[87,14],[14,317],[317,402],[402,318],[318,324],[324,308],[78,191],[191,80],[80,81],[81,82],[82,13],[13,312],[312,311],[311,310],[310,415],[415,308]],la=[[33,7],[7,163],[163,144],[144,145],[145,153],[153,154],[154,155],[155,133],[33,246],[246,161],[161,160],[160,159],[159,158],
[158,157],[157,173],[173,133]],qa=[[46,53],[53,52],[52,65],[65,55],[70,63],[63,105],[105,66],[66,107]],ra=[[263,249],[249,390],[390,373],[373,374],[374,380],[380,381],[381,382],[382,362],[263,466],[466,388],[388,387],[387,386],[386,385],[385,384],[384,398],[398,362]],sa=[[276,283],[283,282],[282,295],[295,285],[300,293],[293,334],[334,296],[296,336]],ta=[[10,338],[338,297],[297,332],[332,284],[284,251],[251,389],[389,356],[356,454],[454,323],[323,361],[361,288],[288,397],[397,365],[365,379],[379,
378],[378,400],[400,377],[377,152],[152,148],[148,176],[176,149],[149,150],[150,136],[136,172],[172,58],[58,132],[132,93],[93,234],[234,127],[127,162],[162,21],[21,54],[54,103],[103,67],[67,109],[109,10]],ua=[].concat(y(ka),y(la),y(qa),y(ra),y(sa),y(ta));function va(a,b,c){c=a.createShader(0===c?a.VERTEX_SHADER:a.FRAGMENT_SHADER);a.shaderSource(c,b);a.compileShader(c);if(!a.getShaderParameter(c,a.COMPILE_STATUS))throw Error("Could not compile WebGL shader.\n\n"+a.getShaderInfoLog(c));return c};function wa(a,b){this.h=a;this.j=b;this.i=0};var xa=new Uint8Array([0,97,115,109,1,0,0,0,1,4,1,96,0,0,3,2,1,0,10,9,1,7,0,65,0,253,15,26,11]);function ya(a,b){return b+a}function za(a,b){window[a]=b}function Aa(a){var b=document.createElement("script");b.setAttribute("src",a);b.setAttribute("crossorigin","anonymous");document.body.appendChild(b);return new Promise(function(c){b.addEventListener("load",function(){c()},!1)})}
function Ba(a){for(var b=[],c=a.size(),d=0;d<c;++d){var f=a.get(d);b.push({x:f.x,y:f.y,visibility:f.hasVisibility?f.visibility:void 0})}return b}function Ca(a,b,c){this.graph=a;this.locateFile=b;this.C=c}Ca.prototype.toArrayBuffer=function(){return X(this,function b(){var c=this,d;return S(b,function(f){return 1==f.g?(c.graph.url?f=P(f,fetch(c.locateFile(c.graph.url,c.C)),3):(f.g=2,f=void 0),f):2!=f.g&&(d=f.j,d.body)?f.return(d.arrayBuffer()):f.return(new ArrayBuffer(0))})})};
function Da(){return X(this,function b(){return S(b,function(c){switch(c.g){case 1:return c.m=2,P(c,WebAssembly.instantiate(xa),4);case 4:c.g=3;c.m=0;break;case 2:return c.m=0,c.i=null,c.return(!1);case 3:return c.return(!0)}})})}
function Y(a){this.h=a;this.listeners={};this.s={};this.A={};this.l=this.F=!0;this.o=Promise.resolve();this.locateFile=a&&a.locateFile||ya;if("object"===typeof window)a=window.location.pathname.toString().substring(0,window.location.pathname.toString().lastIndexOf("/"))+"/";else if("undefined"!==typeof location)a=location.pathname.toString().substring(0,location.pathname.toString().lastIndexOf("/"))+"/";else throw Error("solutions can only be loaded on a web page or in a web worker");this.C=a}
Y.prototype.close=function(){this.i&&this.i.delete();return Promise.resolve()};
function Ea(a){return X(a,function c(){var d=this,f,k,e,g,h,l,m,t,q;return S(c,function(n){switch(n.g){case 1:f=d;if(!d.F)return n.return();za("createMediapipeSolutionsWasm",{locateFile:d.locateFile});za("createMediapipeSolutionsPackedAssets",{locateFile:d.locateFile});k=d.h.files||[];return P(n,Da(),2);case 2:return e=n.j,P(n,Promise.all(k.map(function(r){return void 0===r.simd||r.simd&&e||!r.simd&&!e?Aa(f.locateFile(r.url,f.C)):Promise.resolve()})),3);case 3:return g=window.createMediapipeSolutionsWasm,
h=window.createMediapipeSolutionsPackedAssets,P(n,g(h),4);case 4:return d.g=n.j,d.j=document.createElement("canvas"),d.g.canvas=d.j,d.g.createContext(d.j,!0,!0,{}),d.i=new d.g.SolutionWasm,l=new Ca(d.h.graph,d.locateFile,d.C),P(n,d.loadGraph(l),5);case 5:if(d.h.listeners)for(m=v(d.h.listeners),t=m.next();!t.done;t=m.next())q=t.value,Fa(d,q);d.F=!1;n.g=0}})})}
...
function Ga(a){return X(a,function c(){var d=this,f,k,e,g,h;return S(c,function(l){if(!d.l)return l.return();f=d.j.getContext("webgl2");if(!f)return alert("Failed to create WebGL canvas context when passing video frame."),l.return();d.D=f;if(d.m){k=new d.g.GraphOptionChangeRequestList;e=v(d.m);for(g=e.next();!g.done;g=e.next())h=g.value,k.push_back(h);d.i.changeOptions(k);k.delete();d.m=void 0}d.l=!1;l.g=0})})}
Y.prototype.initialize=function(){return X(this,function b(){var c=this;return S(b,function(d){return 1==d.g?P(d,Ea(c),2):P(d,Ga(c),0)})})};Y.prototype.loadGraph=function(a){return X(this,function c(){var d,f=this;return S(c,function(k){if(1==k.g)return P(k,a.toArrayBuffer(),2);d=k.j;f.i.loadGraph(d);k.g=0})})};
Y.prototype.send=function(a,b){return X(this,function d(){var f=this,k,e,g,h,l,m,t,q;return S(d,function(n){if(1==n.g){if(!f.h.inputs)return n.return();k=1E3*(b||performance.now());return P(n,f.o,2)}if(3!=n.g)return P(n,f.initialize(),3);e=new f.g.PacketDataList;g=v(Object.keys(a));for(h=g.next();!h.done;h=g.next())if(l=h.value,m=f.h.inputs[l]){a:{var r=a[l];switch(m.type){case "video":var p=f.s[m.stream];p||(p=new wa(f.g,f.D),f.s[m.stream]=p);0===p.i&&(p.i=p.h.createTexture());var w=p.j;w.canvas.width=
r.videoWidth;w.canvas.height=r.videoHeight;w.activeTexture(w.TEXTURE0);p.h.bindTexture2d(p.i);w.texImage2D(w.TEXTURE_2D,0,w.RGBA,w.RGBA,w.UNSIGNED_BYTE,r);p.h.bindTexture2d(0);p={glName:p.i,width:r.videoWidth,height:r.videoHeight};break a;default:p={}}}t=p;q=m.stream;e.pushTexture2d(Object.assign(Object.assign({},t),{stream:q,timestamp:k}))}f.i.send(e);e.delete();n.g=0})})};
function Ha(a,b,c){if(c.isNumber())return c.getNumber();if(c.isRect())return c.getRect();if(c.isLandmarks())return c.getLandmarks();if(c.isLandmarksList())return c.getLandmarksList();if(c.isClassificationsList())return c.getClassificationsList();if(c.isTexture2d()){var d=a.A[b];d||(d=new wa(a.g,a.D),a.A[b]=d);a=d;c=c.getTexture2d();b=a.j;if(void 0===a.l){d=va(b,"\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }",
0);var f=va(b,"\n  precision highp float;\n  varying vec2 vTex;\n  uniform sampler2D sampler0;\n  void main(){\n    gl_FragColor = texture2D(sampler0, vTex);\n  }",1),k=b.createProgram();b.attachShader(k,d);b.attachShader(k,f);b.linkProgram(k);if(!b.getProgramParameter(k,b.LINK_STATUS))throw Error("Could not compile WebGL program.\n\n"+b.getProgramInfoLog(k));d=a.l=k;b.useProgram(d);f=b.getUniformLocation(d,"sampler0");a.g={v:b.getAttribLocation(d,"aVertex"),u:b.getAttribLocation(d,"aTex"),V:f};a.o=
...
function Fa(a,b){for(var c=b.name||"$",d=[].concat(y(b.wants)),f=new a.g.StringList,k=v(b.wants),e=k.next();!e.done;e=k.next())f.push_back(e.value);k=a.g.PacketListener.implement({onResults:function(g){return X(a,function l(){var m,t,q=this,n,r;return S(l,function(p){if(1==p.g){m={};for(t=0;t<b.wants.length;++t)m[d[t]]=Ha(q,b.wants[t],g.get(t));if(b.outs){for(var w=m,ma=b.outs,F={},na=v(Object.keys(ma)),x=na.next();!x.done;x=na.next()){x=x.value;var B=ma[x];if("string"===typeof B)F[x]=w[B];else{var H=
w[B.stream];if(void 0!==H){if("landmarks"===B.type)F[x]=Ba(H);else if("landmarks_list"===B.type){for(var L=[],U=H.size(),G=0;G<U;++G){var M=H.get(G);L.push(Ba(M))}F[x]=L}else if("classifications_list"===B.type){L=[];U=H.size();for(G=0;G<U;++G){var oa=H.get(G);M=L;for(var Ia=M.push,pa=[],Ja=oa.size(),V=0;V<Ja;++V){var W=oa.get(V);pa.push({index:W.index,score:W.score,label:W.label})}Ia.call(M,pa)}F[x]=L}else throw Error("Unknown output config type: '"+B.type+"'");B.transform&&(F[x]=B.transform(F[x]))}}}m=
F}(n=q.listeners[c])?p=P(p,q.o,3):(p.g=0,p=void 0);return p}if(r=n(m))return q.o=r,p.return(r);p.g=0})})}});a.i.attachMultiListener(f,k);f.delete()}Y.prototype.onResults=function(a,b){this.listeners[b||"$"]=a};T("Solution",Y);T("OptionType",{NUMBER:0,BOOL:1,0:"NUMBER",1:"BOOL"});function Z(a){a=a||{};this.g=new Y({locateFile:a.locateFile,files:[{url:"holistic_solution_packed_assets_loader.js"},{simd:!1,url:"holistic_solution_wasm_bin.js"},{simd:!0,url:"holistic_solution_simd_wasm_bin.js"}],graph:{url:"holistic.binarypb"},inputs:{image:{type:"video",stream:"input_frames_gpu"}},listeners:[{wants:["left_hand_landmarks","right_hand_landmarks","face_landmarks","pose_landmarks","image_transformed"],outs:{image:"image_transformed",leftHandLandmarks:{type:"landmarks",stream:"left_hand_landmarks"},
rightHandLandmarks:{type:"landmarks",stream:"right_hand_landmarks"},faceLandmarks:{type:"landmarks",stream:"face_landmarks"},poseLandmarks:{type:"landmarks",stream:"pose_landmarks"}}}],options:{selfieMode:{type:1,graphOptionXref:{calculatorType:"GlScalerCalculator",calculatorIndex:1,fieldName:"flip_horizontal"}},upperBodyOnly:{type:1,graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorUpperBodyOnly",fieldName:"bool_value"}},smoothLandmarks:{type:1,
graphOptionXref:{calculatorType:"ConstantSidePacketCalculator",calculatorName:"ConstantSidePacketCalculatorSmoothLandmarks",fieldName:"bool_value"}},minDetectionConfidence:{type:0,graphOptionXref:{calculatorType:"TensorsToDetectionsCalculator",calculatorName:"holisticlandmarkgpu__poselandmarkgpu__posedetectiongpu__TensorsToDetectionsCalculator",fieldName:"min_score_thresh"}},minTrackingConfidence:{type:0,graphOptionXref:{calculatorType:"ThresholdingCalculator",calculatorName:"holisticlandmarkgpu__poselandmarkgpu__poselandmarkbyroigpu__ThresholdingCalculator",
fieldName:"threshold"}}}})}Z.prototype.close=function(){this.g.close();return Promise.resolve()};Z.prototype.onResults=function(a){this.g.onResults(a)};Z.prototype.initialize=function(){return X(this,function b(){var c=this;return S(b,function(d){return P(d,c.g.initialize(),0)})})};Z.prototype.send=function(a){return X(this,function c(){var d=this;return S(c,function(f){return P(f,d.g.send(a),0)})})};Z.prototype.setOptions=function(a){this.g.setOptions(a)};T("Holistic",Z);T("FACEMESH_LIPS",ka);
T("FACEMESH_LEFT_EYE",la);T("FACEMESH_LEFT_EYEBROW",qa);T("FACEMESH_RIGHT_EYE",ra);T("FACEMESH_RIGHT_EYEBROW",sa);T("FACEMESH_FACE_OVAL",ta);T("FACEMESH_CONTOURS",ua);
T("FACEMESH_TESSELATION",[[127,34],[34,139],[139,127],[11,0],[0,37],[37,11],[232,231],[231,120],[120,232],[72,37],[37,39],[39,72],[128,121],[121,47],[47,128],[232,121],[121,128],[128,232],[104,69],[69,67],[67,104],[175,171],[171,148],[148,175],[118,50],[50,101],[101,118],[73,39],[39,40],[40,73],[9,151],[151,108],[108,9],[48,115],[115,131],[131,48],[194,204],[204,211],[211,194],[74,40],[40,185],[185,74],[80,42],[42,183],[183,80],[40,92],[92,186],[186,40],[230,229],[229,118],[118,230],[202,212],[212,
...
T("POSE_CONNECTIONS",[[0,1],[1,2],[2,3],[3,7],[0,4],[4,5],[5,6],[6,8],[9,10],[11,12],[11,13],[13,15],[15,17],[15,19],[15,21],[17,19],[12,14],[14,16],[16,18],[16,20],[16,22],[18,20],[11,23],[12,24],[23,24],[23,25],[24,26],[25,27],[26,28],[27,29],[28,30],[29,31],[30,32],[27,31],[28,32]]);
T("POSE_LANDMARKS",{NOSE:0,RIGHT_EYE_INNER:1,RIGHT_EYE:2,RIGHT_EYE_OUTER:3,LEFT_EYE_INNER:4,LEFT_EYE:5,LEFT_EYE_OUTER:6,RIGHT_EAR:7,LEFT_EAR:8,MOUTH_RIGHT:9,MOUTH_LEFT:10,RIGHT_SHOULDER:11,LEFT_SHOULDER:12,RIGHT_ELBOW:13,LEFT_ELBOW:14,RIGHT_WRIST:15,LEFT_WRIST:16,RIGHT_PINKY:17,LEFT_PINKY:18,RIGHT_INDEX:19,LEFT_INDEX:20,RIGHT_THUMB:21,LEFT_THUMB:22,RIGHT_HIP:23,LEFT_HIP:24,U:25,P:26,R:27,M:28,T:29,O:30,S:31,N:32});}).call(this);
