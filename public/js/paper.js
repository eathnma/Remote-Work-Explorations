...
function onFrame(event) {
    ...
    //attach arm to wrist
    theirArm.firstSegment.point = theirHand.firstSegment.point + new Point(60, 50);
    yourArm.firstSegment.point = yourHand.firstSegment.point + new Point(-60, -30);
    
    //move hand
    theirHand.position = lastMousePosition;
    yourHand.position = lastMousePosition + new Point(-300, 0);
